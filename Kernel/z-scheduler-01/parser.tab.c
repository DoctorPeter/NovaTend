...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     TOK_AND = 259,
     TOK_OR = 260,
     TOK_TIME_PERIOD_CONDITION = 261,
     TOK_DATE_PERIOD_CONDITION = 262,
     TOK_DAYS_PERIOD_CONDITION = 263,
     TOK_COUNT_CONDITION = 264,
     TOK_TIME = 265,
     TOK_DATE = 266,
     TOK_DAY = 267,
     TOK_COUNT = 268,
...
{
      21,     0,    -1,    22,    -1,     6,    15,    10,    16,    10,
      17,    -1,     7,    15,    11,    16,    11,    17,    -1,     8,
      15,    12,    16,    12,    17,    -1,     9,    15,    13,    16,
      13,    17,    -1,     3,    22,    -1,    22,     4,    22,    -1,
      22,     5,    22,    -1,    18,    22,    19,    -1
};
...
{
  "$end", "error", "$undefined", "TOK_NOT", "TOK_AND", "TOK_OR",
  "TOK_TIME_PERIOD_CONDITION", "TOK_DATE_PERIOD_CONDITION",
  "TOK_DAYS_PERIOD_CONDITION", "TOK_COUNT_CONDITION", "TOK_TIME",
  "TOK_DATE", "TOK_DAY", "TOK_COUNT", "UNARY", "'['", "'-'", "']'", "'('",
  "')'", "$accept", "condition_statement", "condition", YY_NULL
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,   267,   268,   269,    91,    45,    93,    40,    41
};
# endif
...
{
       0,     0,   -11,    -2,     2,     4,     0,    12,    -3,   -12,
      10,     3,     9,    11,     6,   -12,     0,     0,     7,    13,
      14,    15,   -12,   -12,   -12,    16,    17,    20,    21,     5,
      18,    19,    22,   -12,   -12,   -12,   -12
};
...
{
       9,    16,    17,     1,    10,    14,     2,     3,     4,     5,
      16,    17,    15,    11,    19,    23,    24,    12,     6,    13,
      18,    20,    33,    25,    21,    22,    29,     0,    30,    26,
      27,    28,    31,     0,    32,    34,    35,     0,     0,    36
};
...
{
       1,     4,     5,     3,    15,     6,     6,     7,     8,     9,
       4,     5,     0,    15,    11,    16,    17,    15,    18,    15,
      10,    12,    17,    16,    13,    19,    10,    -1,    11,    16,
      16,    16,    12,    -1,    13,    17,    17,    -1,    -1,    17
};
...
{
       0,     3,     6,     7,     8,     9,    18,    21,    22,    22,
      15,    15,    15,    15,    22,     0,     4,     5,    10,    11,
      12,    13,    19,    22,    22,    16,    16,    16,    16,    10,
      11,    12,    13,    17,    17,    17,    17
};
...
/* Line 1792 of yacc.c  */
#line 56 "parser.y"
    {(yyval.node) = make_condition_node(NULL, NULL, TIME_PERIOD_CONDITION, &((yyvsp[(3) - (6)].time_value)), &((yyvsp[(5) - (6)].time_value)), 0, 0);}
    break;

  case 4:
/* Line 1792 of yacc.c  */
#line 57 "parser.y"
    {(yyval.node) = make_condition_node(NULL, NULL, DATE_PERIOD_CONDITION, &((yyvsp[(3) - (6)].time_value)), &((yyvsp[(5) - (6)].time_value)), 0, 0);}
    break;

  case 5:
/* Line 1792 of yacc.c  */
#line 58 "parser.y"
    {(yyval.node) = make_condition_node(NULL, NULL, DAYS_PERIOD_CONDITION, &((yyvsp[(3) - (6)].time_value)), &((yyvsp[(5) - (6)].time_value)), 0, 0);}
    break;

  case 6:
/* Line 1792 of yacc.c  */
#line 59 "parser.y"
    {(yyval.node) = make_condition_node(NULL, NULL, COUNT_CONDITION, NULL, NULL, (yyvsp[(5) - (6)].int_value), (yyvsp[(3) - (6)].int_value));}
    break;

  case 7:
/* Line 1792 of yacc.c  */
#line 60 "parser.y"
    {(yyval.node) = make_condition_node((yyvsp[(2) - (2)].node), NULL, NOT_OPERATION, NULL, NULL, 0, 0);}
    break;

  case 8:
/* Line 1792 of yacc.c  */
#line 61 "parser.y"
    {(yyval.node) = make_condition_node((yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node), AND_OPERATION, NULL, NULL, 0, 0);}
    break;

  case 9:
/* Line 1792 of yacc.c  */
#line 62 "parser.y"
    {(yyval.node) = make_condition_node((yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node), OR_OPERATION, NULL, NULL, 0, 0);}
    break;
